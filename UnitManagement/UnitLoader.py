...
# Utility class that manages the loading of Unit information and the various components of that
...
class UnitLoader():
    ...
    # Creates a Unit and adds it to the array of currently created units
