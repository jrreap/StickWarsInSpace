...
from Scenes.Lore.SpaceMongolianLorePeter import SpaceMongolianLorePeter
...
class SpaceMongolianLoreMatthew (SceneBase):
    ...
    def Continue(self):
        print("Next Lore")
        self.SwitchToScene(SpaceMongolianLorePeter())

    def GoBack(self):
        print("Returning to jaydonlore...")
        self.SwitchToScene("Scenes.Lore.SpaceMongolianLoreJaydon.SpaceMongolianLoreJaydon")
